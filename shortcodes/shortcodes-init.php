...
/* Custom Shortcode */
add_shortcode('apptivo_ecommerce_products_by_category', 'apptivo_ecommerce_products_by_category');
add_shortcode('apptivo_ecommerce_featured_products', 'apptivo_ecommerce_featured_products');
add_shortcode('apptivo_ecommerce_recent_products', 'apptivo_ecommerce_recent_products');
add_shortcode('apptivo_ecommerce_products_by_price', 'apptivo_ecommerce_products_by_price');
/*
